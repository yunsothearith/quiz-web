...
export class HelpersNavigationCollapsableItemComponent implements OnInit, OnDestroy
{
    ...
    ngOnInit(): void
    {
        ...
        this._helperslNavigationComponent.onCollapsableItemCollapsed
        ...
        if ( this.autoCollapse )
        {
            this._helperslNavigationComponent.onCollapsableItemExpanded
                .pipe(takeUntil(this._unsubscribeAll))
    ...
    collapse(): void
    {
        ...
        this._helperslNavigationComponent.onCollapsableItemCollapsed.next(this.item);
    }
    ...
    expand(): void
    {
        ...
        // Execute the observable
        this._helperslNavigationComponent.onCollapsableItemExpanded.next(this.item);
    }
