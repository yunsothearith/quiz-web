...
import { HelpersHighlightService } from 'helpers/components/highlight/highlight.service';

@Component({
    selector       : 'textarea[helpers-highlight]',
    templateUrl    : './highlight.component.html',
    styleUrls      : ['./highlight.component.scss'],
    encapsulation  : ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs       : 'helpersHighlight',
    standalone     : true,
    imports        : [NgClass],
})
export class HelpersHighlightComponent implements OnChanges, AfterViewInit
{
    @Input() code: string;
    @Input() lang: string;
    ...
    constructor(
        ...
        private _helpersHighlightService: HelpersHighlightService,
    ...
    private _highlightAndInsert(): void
    {
        ...
        this.highlightedCode = this._domSanitizer.sanitize(SecurityContext.HTML, this._helpersHighlightService.highlight(this.code, this.lang));
